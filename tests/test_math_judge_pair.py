...
def test_config_pins_models_caps_prompt_and_disjoint_local_endpoints() -> None:
    ...
    assert qwen["agents"]["judge"]["model_settings"]["sampling"]["train"]["presence_penalty"] == 1.0
    assert qwen["agents"]["judge"]["model_settings"]["sampling"]["eval"]["presence_penalty"] == 1.0
...
def test_manifest_identity_pins_dataset_model_and_adapter_sources() -> None:
    ...
    assert identity["judge_generation_by_arm"]["qwen"]["presence_penalty"] == 1.0

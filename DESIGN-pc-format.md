...
| 2 | last word | critic speaks last every round | **kept** — protocol ends defense → rebuttal |
...
protocol slot names onto cues (protocols stay declarative). Stages compose
...
`configs/math_pc_debate.yaml` gains the protocol above; training block
